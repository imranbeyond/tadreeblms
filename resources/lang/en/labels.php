...
return array(
  ...
  array(
    ...
    'smtp_settings' => array(
      ...
      'mail_mailer_note' => 'Select the mail driver/mailer to use for sending emails (SMTP recommended for production).',
      'mail_host' => 'SMTP Host',
      'mail_host_note' => 'Enter your SMTP server host address (e.g., smtp.gmail.com, smtp.office365.com).',
      'mail_port' => 'SMTP Port',
      'mail_port_note' => 'Common ports: 587 (TLS), 465 (SSL), 25 (unsecured). Use 587 for most SMTP servers.',
      'mail_username' => 'SMTP Username',
      'mail_username_note' => 'Enter your SMTP username (usually your email address).',
      'mail_password' => 'SMTP Password',
      'mail_password_placeholder' => 'Enter new password',
      'mail_password_note' => 'Enter your SMTP password or app-specific password. Leave empty to keep current password.',
      'password_exists' => 'A password is currently configured. Leave empty to keep existing password.',
      'mail_encryption' => 'Encryption',
      'mail_encryption_note' => 'TLS is recommended for port 587. Use SSL for port 465. Select None only if your server does not support encryption.',
      'mail_from_address' => 'From Email Address',
      'mail_from_address_note' => 'This email address will appear as the sender for all outgoing emails.',
      'mail_from_name' => 'From Name',
      'mail_from_name_note' => 'This name will appear as the sender name for all outgoing emails.',
      'save_success' => 'SMTP settings saved successfully! Configuration cache has been refreshed.',
      'save_error' => 'Failed to save SMTP settings',
      'test_email_title' => 'Test Email Configuration',
      'test_email_info' => 'Send a test email to verify your SMTP configuration is working correctly. Make sure to save your settings before testing.',
      ...
      'test_email_body' => 'This is a test email to verify your SMTP configuration is working correctly. If you received this email, your SMTP settings are configured properly.',
    ),
    'stripe' => array(
      'plan' => array(
        'title' => 'Stripe Plans',
